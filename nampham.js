(() => {
                                    ...
                                    var g = function () {
                                        ...
                                        try {
                                            ...
                                            if (r && "undefined" !== typeof Promise && (r instanceof Promise || "function" === typeof r.then) ? (n._playLock = !0, m(), r.then((function () {
                                                    ...
                                                    n._playLock = !1, n._emit("playerror", i._id, "Quá trình phát lại không thể bắt đầu. Đây là sự cố thường gặp nhất trên thiết bị di động và Chrome khi quá trình phát lại không nằm trong phạm vi tương tác của người dùng"), i._ended = !0, i._paused = !0
                                                }))) : t || (n._playLock = !1, m(), n._emit("play", i._id)), h.playbackRate = i._rate, h.paused) return void n._emit("playerror", i._id, "Quá trình phát lại không thể bắt đầu. Đây là sự cố thường gặp nhất trên thiết bị di động và Chrome khi quá trình phát lại không nằm trong phạm vi tương tác của người dùng.");
                        ...
                        s = function (e) {
                            ...
                            if (/^data:[^;]+;base64,/.test(t)) {
                                ...
                                o.open(e._xhr.method, t, !0), o.withCredentials = e._xhr.withCredentials, o.responseType = "arraybuffer", e._xhr.headers && Object.keys(e._xhr.headers).forEach((function (t) {
                                    ...
                                    var t = (o.status + "")[0];
                                    "0" === t || "2" === t || "3" === t ? d(o.response, e) : e._emit("loaderror", null, "Không tải được tệp âm thanh có trạng thái: " + o.status + ".")
                                }, o.onerror = function () {
    ...
    n.g = function () {
        ...
        const T = [{
                title: "Discord",
                url: "https://discord.com/users/1087374872159731782",
                icon: (0, E.jsx)(y, {})
            }, {
                title: "Github",
                url: "https://github.com/namdevelop",
                icon: (0, E.jsx)(_, {})
            }, {
                title: "Mail",
                url: "https://www.facebook.com/NamPhamDev/",
                icon: (0, E.jsx)(c, {})
            }],
            N = e => {
                let {
            ...
            O = e => {
                ...
                return (0, E.jsxs)("div", {
                    ...
                    children: [(0, E.jsx)("input", {
                        ref: l,
                        type: "text",
                        placeholder: "Hãy gõ chữ 'help' để bắt đầu!",
                        value: t,
                        onChange: n,
                        onKeyPress: r,
                        onKeyDown: a,
            ...
            z = () => (0, E.jsxs)("div", {
                ...
                children: [(0, E.jsxs)("p", {
                    className: "",
                    children: ["Website by NamPham, Phiên bản ", (0, E.jsx)("span", {
                    ...
                    className: "",
                    children: ["Các lệnh shell này được xác định nội bộ. Hãy gõ", " ", (0, E.jsx)("span", {
                        className: "text-ctp-blue",
                        children: "'help'"
                    }), " để mở danh sách lệnh."]
            ...
            F = () => {
                ...
                return (0, e.useEffect)((() => {
                    (async () => {
                        let e;
                        if (H("/nampham.json")) e = H("/nampham.json");
                        else {
                            const t = await fetch("/nampham.json");
                            e = await t.json(), D("/nampham.json", e)
                        }
                        n(e)
                    })()
                }), []), (0, E.jsxs)("div", {
                    ...
                    children: [(0, E.jsx)("img", {
                        ...
                        children: [(0, E.jsxs)("div", {
                            ...
                            className: "",
                            children: "Xin chào ! Tôi đến từ Ninh Bình."
                        }), (0, E.jsxs)("p", {
                            className: "",
                            children: ["Tôi thích chơi", " ", (0, E.jsxs)("span", {
                                className: "text-ctp-green",
                                children: ["Game, Yêu tổ quốc yêu đồng bào ", " "]
                            }), " và ", (0, E.jsx)("span", {
                                className: "italic",
                                children: "luôn chia sẻ giúp đỡ mọi người"
                            })]
                        }), (0, E.jsxs)("p", {
                            className: "",
                            children: ["Người ", (0, E.jsx)("span", {
                                className: "text-ctp-red",
                                children: "Đam Mê"
            ...
            U = [{
                ...
                command: "echo",
                display: "echo [arg ...]",
                description: "Viết đối số cho đầu ra tiêu chuẩn."
            }, {
                icon: (0, E.jsx)(h, {}),
                command: "random",
                display: "random <num>",
                description: "Trả về số giả ngẫu nhiên trong khoảng từ 0 đến 1 hoặc bạn có thể thử dự đoán kết quả!"
            }, {
                icon: (0, E.jsx)(d, {}),
                command: "clear",
                display: "clear",
                ...
                command: "fun",
                display: "fun",
                description: "Một chút giải trí"
            }, {
                icon: (0, E.jsx)(w, {}),
                command: "play",
                display: "play",
                description: "Một chút nhạc nền :3)"
            }, {
                icon: (0, E.jsx)(x, {}),
                command: "stop",
                display: "stop",
                ...
                command: "myip",
                display: "myip",
                description: " IPv4 của bạn 🐱‍💻"
            }, {
                icon: (0, E.jsx)(p, {}),
                command: "b64",
                display: "b64 [string]",
                description: "Mã hóa sang định dạng Base64"
            }, {
                icon: (0, E.jsx)(p, {}),
                command: "db64",
                display: "db64 [base64]",
                description: "Giải mã từ định dạng Base64"
            }].sort(((e, t) => e.command.localeCompare(t.command))),
            $ = ["discord.js-selfbot-v13", "DiscordBotClient"],
            W = e => {
                let {
                    input: t,
                    output: n,
                ...
                return (0, E.jsxs)("div", {
                    ...
                    children: [a ? (0, E.jsx)("div", {}) : (0, E.jsxs)("div", {
                        ...
                        className: "",
                        children: "Bạn đã gõ sai lệnh ⚠️: ".concat(t)
                    })]
                })
            };
        var Q, Z = n(257);
                    ...
                    g = function () {
                        ...
                        case "play":
                            f.stopped && f.play(), p({
                                ...
                                text: (0, E.jsx)(W, {
                                    input: e,
                                    output: "Nhạc đã được bật. Để dừng phát lại, vui lòng nhập 'stop'",
                                    isCommand: !0
                                })
                            });
                            break;
                        case "stop":
                            f.stopped || f.stop(), p({
                                ...
                                text: (0, E.jsx)(W, {
                                    input: e,
                                    output: "Nhạc đã tắt. Để tiếp tục chơi vui lòng nhập 'play'",
                                    isCommand: !0
                                })
                            });
                            break;
                        ...
                        case "random": {
                            ...
                            _ ? p({
                                ...
                                text: (0, E.jsx)(W, {
                                    input: e,
                                    output: Number(_) === b ? "Bạn dự đoán đúng số🎉" : "Bạn đã dự đoán sai số ;-;",
                                    isCommand: !0,
                                    isNewLine: !1
                                })
                            }, {
                                ...
                                text: (0, E.jsx)(W, {
                                    input: e,
                                    output: "Câu trả lời đúng là:".concat(b),
                                    isCommand: !0,
                                    isNewLine: !0
                                })
                            }, {
                ...
                return (0, e.useEffect)((() => {
                    ...
                    children: [(0, E.jsxs)("div", {
                        ...
                        children: (0, E.jsx)("div", {
                            ...
                            children: (0, E.jsx)("span", {
                                className: "block",
                                children: "© Copyright Nam Phạm. All rights reserved."
                            })
                        })
                    })]
                })
